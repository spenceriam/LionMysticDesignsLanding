        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="glass-effect p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-white">1. Introduction</h2>
              <p className="text-gray-200">
                Lion Mystic ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains
                how we collect, use, and safeguard your information when you use our contact form.
              </p>

              <h2 className="text-xl font-semibold mt-6 mb-4 text-white">2. Contact Form Information</h2>
              <p className="text-gray-200">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-white">3. How We Use Your Information</h2>
              <p className="text-gray-200">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-white">4. Data Storage and Security</h2>
              <p className="text-gray-200">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-white">5. Data Retention</h2>
              <p className="text-gray-200">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-white">6. Your Rights</h2>
              <p className="text-gray-200">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-white">7. Contact Us</h2>
              <p className="text-gray-200">
