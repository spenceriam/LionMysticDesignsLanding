    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="w-full py-4 px-6 flex items-center justify-between bg-black z-20 sticky top-0">
        <div className="flex items-center gap-2">
          <Image src="/images/lion-mystic-logo-blue.png" alt="Lion Mystic Designs Logo" width={40} height={40} />
        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="glass-effect p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-blue-400">1. Agreement to Terms</h2>
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-blue-400">2. Use License</h2>
              <p className="text-gray-200">
                Permission is granted to temporarily download one copy of the materials on Lion Mystic Designs's website
              ...
              <ul className="list-disc pl-6 mt-2 text-gray-200">
                ...
                <li>
                  Attempt to decompile or reverse engineer any software contained on Lion Mystic Designs's website;
                </li>
                <li>Remove any copyright or other proprietary notations from the materials; or</li>
                <li>Transfer the materials to another person or "mirror" the materials on any other server.</li>
              </ul>

              <h2 className="text-xl font-semibold mt-6 mb-4 text-blue-400">3. Disclaimer</h2>
              <p className="text-gray-200">
                The materials on Lion Mystic Designs's website are provided on an 'as is' basis. Lion Mystic Designs
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4 text-blue-400">4. Limitations</h2>
              <p className="text-gray-200">
                In no event shall Lion Mystic Designs or its suppliers be liable for any damages (including, without
                limitation, damages for loss of data or profit, or due to business interruption) arising out of the use
                or inability to use the materials on Lion Mystic Designs's website, even if Lion Mystic Designs or a
                Lion Mystic Designs authorized representative has been notified orally or in writing of the possibility
                of such damage.
              </p>

              <h2 className="text-xl font-semibold mt-6 mb-4 text-blue-400">5. Contact Us</h2>
      ...
      <footer className="fixed bottom-0 left-0 right-0 py-4 px-6 bg-black text-white z-10 shadow-lg">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center gap-2 mb-2 md:mb-0">
            <Image src="/images/lion-mystic-logo-blue.png" alt="Lion Mystic Designs Logo" width={24} height={24} />
